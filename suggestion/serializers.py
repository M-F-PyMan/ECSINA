...
class ProposalVideoSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProposalVideo
        fields = ['id', 'title', 'video_file', 'created_at']

class ProposalRoadmapSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProposalRoadmap
        fields = ['id', 'title', 'roadmap_file', 'created_at']

class ProposalGuidebookSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProposalGuidebook
        fields = ['id', 'title', 'guidebook_file', 'created_at']

class ProposalSampleFileSerializer(serializers.ModelSerializer):
    class Meta:
        model = ProposalSampleFile
        fields = ['id', 'title', 'sample_file', 'created_at']

class SuggestedTitleSerializer(serializers.ModelSerializer):
    class Meta:
